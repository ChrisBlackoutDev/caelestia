...
create_bind("mouse:272", hl.dsp.exec_cmd("~/.config/hypr/scripts/raise-windowed-click.fish"), release)
...
create_bind(
    ...
    hl.dsp.exec_cmd("~/.config/hypr/scripts/toggle-workspace-floating.fish")
)
